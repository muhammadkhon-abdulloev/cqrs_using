...
public class OrderConfiguration: IEntityTypeConfiguration<Order>
{
    public void Configure(EntityTypeBuilder<Order> etp)
    {
        ...
        etp.Property(o => o.SenderCityId).HasColumnName("sender_city_id").IsRequired();
        ...
        etp.Property(o => o.ReceiverCityId).HasColumnName("receiver_city_id").IsRequired();
        ...
        etp.Property(o => o.CreatedAt).HasColumnName("created_at").IsRequired().HasColumnType("timestamptz").HasDefaultValue(DateTime.Now);
    }
}